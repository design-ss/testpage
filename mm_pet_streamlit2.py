...
# ファイル選択
export_files = st.file_uploader("ファイルを選択", accept_multiple_files=True, key="export_files")
...
preview_button1, export_button1 = st.columns(2)
...
# パターン1のプレビューボタンと書き出しボタン
preview_button2, export_button2 = st.columns(2)
with preview_button2:
